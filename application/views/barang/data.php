                ...
                if ($barang) :
                    foreach ($barang as $b) :
                        ...
                        <tr>
                            ...
                            <td><?= $b['stok']; ?></td>
                            <td><?= $b['nama_satuan']; ?></td>
                            <td><img src='./assets/images/<?= $b['qrcode']; ?>' width="200px" height="200px"></td>
                            <td>
                                ...
                                <a href="<?= base_url('barang/detail/') . $b['id_barang'] ?>" class="btn btn-info btn-circle btn-sm"><i class="fa fa-info"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else : ?>
