            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('role', 'pejabat'); ?> value="pejabat" type="radio" id="pejabat" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="pejabat">Pejabat</label>
                        </div>
